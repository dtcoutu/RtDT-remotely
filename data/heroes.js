const archwright = {
  ...
  name: "Archwright",
  color: 'gold',
  summary: 'Controls banners that provide anyone in the same space as then Advantage.',
  expansion: 'alliances',
...
const devious_swindler = {
  ...
  color: 'coral',
  summary: 'Leans on luck with the haggle die and gaining Advantages from treasure cards in the market.',
  expansion: 'covenant',
...
const haunted_recluse = {
  ...
  color: 'indigo',
  summary: 'Moves skulls and can gain Advantages from buildings with skulls on them.',
  expansion: 'alliances',
...
const relentless_warden = {
  ...
  color: 'greenyellow',
  summary: 'Has a quarry token they place on a foe which makes them better at Battling them.',
  expansion: 'covenant',
...
const reverent_astromancer = {
  ...
  color: 'aquamarine',
  summary: 'Gains potions and have benefits in using them and at gaining treasure.',
  expansion: 'covenant',
...
const relic_hunter = {
  ...
  name: "Relic Hunter",
  color: 'darkblue',
  summary: 'Casts spells with some skull cleaning as well.',
  expansion: 'base',
...
const spymaster = {
  ...
  name: "Spymaster",
  color: 'ivory',
  summary: 'Fast movement and can double up on reinforcements.',
  expansion: 'base',
